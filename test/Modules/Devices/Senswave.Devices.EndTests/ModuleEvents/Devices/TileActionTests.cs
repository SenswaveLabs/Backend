...
public class TileActionTests(MqttTestEnvironment factory) : MqttFeatureTest(factory)
{
    [Fact]
    public async Task EventFiredOnAction()
    {
        // Arrange
        ...
        Assert.True(testHarrness.IsMessageInSystem<DeviceTileActionEvent>(), "Event was not published.");
    ...
    public async Task EventFiredOnIncomingAction()
    {
        ...
        // Assert
        Assert.True(testHarrness.Published.Select<DeviceTileActionEvent>().Any(), "Presence event was not published.");
