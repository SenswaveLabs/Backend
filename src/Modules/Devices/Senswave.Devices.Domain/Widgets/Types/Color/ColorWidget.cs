...
public class ColorWidget(
    Widget widget,
    ColorWidgetConfiguration configuration,
    ...
    ILogger<IWidget> logger) : BaseWidget(widget, operation)
{
    ...
    public override ColorWidgetConfiguration Configuration => configuration;
    ...
    {
        var result = await ValidateInternal<ColorWidget, ColorWidgetValidator>();
