...
- __Application__ refers to Senswave, the software program provided by the Company.
...
## Data Controller and Data Administrator

The entity responsible for the collection and processing of your personal data (the “Data Controller”) is:

Data Controller: Łukasz Kolber
Email: senswavelabs@gmail.com

For the purposes of data protection and privacy laws, including the General Data Protection Regulation (GDPR), the California Consumer Privacy Act (CCPA) as amended by the California Privacy Rights Act (CPRA), and the California Online Privacy Protection Act (CalOPPA), Łukasz Kolber acts as the Data Controller — the individual or entity determining the purposes and means of processing personal data.

In certain circumstances, We may also engage third parties to act as Data Processors or Sub-processors, who process data on Our behalf in accordance with written agreements that ensure compliance with applicable data protection laws.
...
- __With Service Providers:__ We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to show advertisements to You to help support and maintain Our Service,  to contact You.
...
Our Application and its Service Providers use cookies and similar tracking technologies to collect and store certain information when You interact with the Service.

Although mobile applications do not use browser cookies in the traditional sense, they may use equivalent technologies such as:

- **SDKs (Software Development Kits):** Code components that collect information about how the Application is used, including device identifiers, session data, and performance metrics.  
- **Mobile Ad Identifiers:** Such as Google Advertising ID (AAID) or Apple ID for Advertisers (IDFA), which allow Us and Our partners to deliver relevant advertising or measure marketing effectiveness.  
- **Local Storage and Preferences:** Data stored on Your device to remember Your settings and preferences.

We use these technologies for the following purposes:
- To operate and maintain the Application;  
- To understand usage and improve performance;  
- To personalize Your experience and deliver relevant content;  
- To measure the effectiveness of marketing campaigns.

#### Managing Tracking Preferences
You can control or limit tracking through Your device settings:

- On **Android:** Go to *Settings → Privacy → Ads → Delete advertising ID* or *Opt out of Ads Personalization*.  
- On **iOS:** Go to *Settings → Privacy → Tracking* and disable *Allow Apps to Request to Track*.  
- You can also reset Your advertising ID at any time in Your device settings.

If You disable these identifiers, certain personalized features or advertisements may no longer function properly.

#### Legal Basis for Use (GDPR)
For users in the European Economic Area (EEA) and the United Kingdom, the use of tracking technologies that are not strictly necessary for providing the Service is based on Your **consent** under Article 6(1)(a) GDPR.  
You can withdraw Your consent at any time by adjusting Your device settings or contacting Us at **senswavelabs@gmail.com**.

#### Third-Party Cookies and Trackers
Our third-party analytics and advertising partners (such as **Google Analytics**, **Firebase**, and **AdMob**) may use their own tracking technologies within our Application. These partners process information in accordance with their privacy policies.
...
#### Google Analytics
Google Analytics is a web analytics service offered by Google that tracks and reports website or app traffic.  
Google uses the data collected to track and monitor the use of Our Service. This data may be shared with other Google services. Google may use the collected data to contextualize and personalize the ads of its own advertising network.

You may opt out of certain Google Analytics features through Your mobile device settings (e.g., advertising settings) or by following Google’s Privacy Policy:  
...
#### Firebase
Firebase is an analytics and development platform provided by Google Inc.  
Firebase helps Us understand user behavior and app performance to improve functionality.

You may opt out of certain Firebase features through Your mobile device settings, such as advertising settings, or by following Google’s Privacy Policy:  
[https://policies.google.com/privacy](https://policies.google.com/privacy)

For details on what data Firebase collects, please refer to:  
...
Behavioral remarketing allows Us and Our partners to use information collected through cookies, SDKs, or other tracking technologies to display ads based on Your past interactions with Our Service.

These ads may appear on other apps, websites, or platforms and are designed to be more relevant to You.

#### Google AdMob
AdMob is a mobile advertising platform provided by Google Inc. that allows Us to display in-app advertisements.  
AdMob may use identifiers such as cookies or mobile advertising IDs to serve personalized ads based on Your interests and interactions.

You can opt out of AdMob personalized advertising by following the instructions provided by Google:  
[https://support.google.com/ads/answer/2662922](https://support.google.com/ads/answer/2662922)  
or through your device settings as described in the **Cookies and Tracking Technologies** section.

For more information on how Google uses the data collected, please visit:  
[https://policies.google.com/technologies/ads](https://policies.google.com/technologies/ads)

#### Legal Basis for Advertising (GDPR)
For users in the EEA and UK, personalized advertising and remarketing are based on Your **consent** under Article 6(1)(a) GDPR.  
You may withdraw Your consent for personalized ads at any time by changing Your device settings or contacting Us at **senswavelabs@gmail.com**.

#### Right to Opt-Out (CCPA/CPRA)
If You are a California resident, You have the right to opt out of the sale or sharing of Your personal information for advertising purposes.  
You may exercise this right by contacting Us or following the instructions in the **“Do Not Sell My Personal Information”** section of this Policy.
...
- __From Service Providers__. For example, third-party vendors to monitor and analyze the use of our Service, third-party vendors to provide advertising on our Service,  or other third-party vendors that We use to provide the Service to You.
